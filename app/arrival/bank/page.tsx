            ...
            <FadeIn delay={0.15}>
              <div className="space-y-5 text-sm leading-relaxed text-black/70 md:text-base">
                <p>
                  ...
                  <strong className="text-[#0c0479]">Checking</strong>{" "}
                  (ใช้จ่ายประจำวัน / รับโอนเงิน / ชำระบิล) และ{" "}
                  <strong className="text-[#0c0479]">Savings</strong>{" "}
                  (เก็บเงินออม) แนะนำให้เริ่มจาก Checking ก่อน
                  และเปิด Savings เพิ่มตามความเหมาะสม
                </p>
                <p>
                  <strong className="text-[#0c0479]">บัตรเดบิต (Debit Card)</strong>{" "}
                  มักได้ทันทีหรือส่งทางไปรษณีย์ ส่วน{" "}
                  <strong className="text-[#0c0479]">บัตรเครดิต (Credit Card)</strong>{" "}
                ...
                <p>
                  ...
                  <strong className="text-[#c40000]">(Secured Card)</strong>{" "}
                  เพื่อสร้างเครดิต
                </p>
                <p>
                  โปรดตรวจสอบ{" "}
                  <strong className="text-[#0c0479]">ค่าธรรมเนียมรายเดือน (monthly fee)</strong>{" "}
