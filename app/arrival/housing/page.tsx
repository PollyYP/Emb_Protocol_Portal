            ...
            <FadeIn delay={0.15}>
              <div className="space-y-5 text-sm leading-relaxed text-black/70 md:text-base">
                <p>
                  ...
                  ทั้งนี้ หากมีข้อสงสัยเกี่ยวกับอัตราค่าเช่าที่กระทรวงฯ อนุมัติ สามารถสอบถามรายละเอียดเพิ่มเติมได้ที่ฝ่ายคลังของสถานเอกอัครราชทูตฯ หรืออ่านระเบียบกระทรวงการคลัง
                  ว่าด้วยการเบิกค่าเช่าบ้านสําหรับข้าราชการซึ่งรับราชการประจําในต่างประเทศ ได้โดย {" "}
                  <a
                    href="/housing-allowance.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm font-semibold text-[#0c0479] transition-all hover:bg-[#0c0479] hover:text-white"
                  >
                    คลิกที่นี่
                  </a>
                </p>
                <p>
                  ...
                  ซึ่งในทางปฏิบัติพบว่าค่าเช่ามักปรับขึ้นตามภาวะตลาดและค่าครองชีพ
                ...
                <div className="rounded-xl border border-black/8 bg-[#fafafa] p-5 space-y-5 text-sm leading-relaxed text-black/70 md:text-base">
                  ...
                  <div>
                    ...
                    <p className="mt-2">
                      มลรัฐเวอร์จิเนียไม่มีกฎหมายควบคุมค่าเช่า ผู้ให้เช่าสามารถขึ้นค่าเช่าได้ในจำนวนเท่าใดก็ได้เมื่อสัญญาครบรอบ
                      โดยไม่มีเพดานที่กฎหมายกำหนด ข้อบังคับที่มีอยู่เพียงประการเดียวคือ
                      ผู้ให้เช่าไม่สามารถขึ้นค่าเช่าในระหว่างที่ยังไม่หมดสัญญา เช่น สัญญาปีต่อปี ไม่สามารถขึ้นค่าเช่ากลางปีได้ เว้นแต่จะถูกระบุเอาไว้ในสัญญา ดังนั้น โปรดอ่านสัญญาให้ละเอียดถี่ถ้วน
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm text-black/40">(Bethesda, North Potomac, Chevy Chase, Rockville)</p>
                    <p className="mt-2">
