        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 sm:py-28 lg:py-32">
          ...
          >
            ...
            <p className="mt-4 text-lg leading-relaxed text-white/60 sm:text-xl">
              Diplomatic Driver&apos;s License <br/>

            </p>
            <p className="text-base leading-relaxed text-white/60">ขั้นตอนการขอใบขับขี่ทางการทูต</p>
          </motion.div>
        </div>
          ...
          <FadeIn>
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-base leading-relaxed text-black/50">
                ...
                และท่านสามารถดำเนินการได้หลังจากได้ทำการรายงานตัว <Link href="/person-management" className="text-[#0c0479]">(NOA)</Link> และมีหมายเลขประจำตัวเรียบร้อยแล้ว
              </p>
            </div>
          </FadeIn>
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-3 gap-4 sm:grid-cols-5">
              {stepsOverview.map((s, i) => (
                <div key={s.number} className="relative text-center">
                  <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[#0c0479]/8 text-lg font-bold text-[#0c0479]">
                    {s.number}
                  </div>
                  <p className="mt-3 text-xs font-medium leading-snug text-black/50 sm:text-sm">
                    {s.title}
                  </p>
              ...
              <div className="overflow-hidden rounded-2xl border border-black/5 bg-white shadow-sm">
                ...
                <div className="p-7 sm:p-8">
                  ...
                  <div className="mt-5 space-y-4 text-[15px] leading-relaxed text-black/55">
                    <p>
                      ท่านสามารถทำข้อสอบออนไลน์ได้
                      โดยจะต้องลงทะเบียนก่อนสอบล่วงหน้าอย่างน้อย 1 วัน
                      ผ่านเว็บไซต์ Proctor360
                    </p>

                    {/* Proctor360 link */}
                    <a
                      href="https://proctor360.com/organization/ofm"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 rounded-xl border border-[#0c0479]/10 bg-[#0c0479]/[0.03] px-5 py-4 transition-colors hover:bg-[#0c0479]/[0.06]"
                    >
                      ...
                      <div>
                        <p className="text-sm font-semibold text-[#0c0479]">
                          DMV Language Selection | Proctor360
                        </p>
                        <p className="mt-0.5 text-xs text-black/40">
                          proctor360.com/organization/ofm
                        </p>
                      </div>
                    ...
                    <p>
                      ข้อสอบจะอิงจากคู่มือกฎจราจรของรัฐเวอร์จิเนีย
                      ท่านสามารถศึกษาล่วงหน้าได้จากเว็บไซต์ Virginia DMV
                    </p>
              ...
              <div className="overflow-hidden rounded-2xl border border-black/5 bg-white shadow-sm">
                ...
                <div className="p-7 sm:p-8">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-lg font-bold tracking-tight text-black/85">
                      นำส่งไฟล์เอกสารทางอีเมลมายังฝ่ายพิธีฯ
                    </h3>
                  </div>

                  <div className="mt-5 space-y-4 text-[15px] leading-relaxed text-black/55">
                    <p>
                      เมื่อทำการสอบเสร็จแล้ว กรุณานำส่งไฟล์เอกสารต่อไปนี้ทางอีเมลมายังฝ่ายพิธีฯ
                      เพื่อให้ดำเนินการในระบบต่อไป
                    </p>

                    <div className="space-y-3 rounded-xl border border-black/5 bg-gray-50/80 p-5">
                      <div className="flex items-start gap-3">
                        <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-[#0c0479]/10 text-[10px] font-bold text-[#0c0479]">
                          1
                        </span>
                        <div>
                          <p className="font-semibold text-black/70">
                            ผลคะแนนการสอบข้อเขียน
                          </p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-semibold text-black/70">
                            ใบแปลใบขับขี่ไทยเป็นภาษาอังกฤษ
                          </p>
                          <p className="mt-0.5 text-sm text-black/45">
                            ดาวน์โหลดแบบฟอร์มด้านล่างและกรอกข้อมูลให้ครบถ้วน
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <Link
                      href="#"
                      className="inline-flex items-center gap-2.5 rounded-lg border border-[#0c0479]/15 bg-[#0c0479]/5 px-5 py-3 text-sm font-semibold text-[#0c0479] transition-all hover:bg-[#0c0479]/10 active:scale-[0.97]"
                    >
                      <svg
                        className="h-4 w-4"
                        fill="none"
                    ...
                    <div className="flex items-start gap-3 rounded-xl border border-[#0c0479]/10 bg-[#0c0479]/[0.03] px-5 py-4">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className="text-sm font-semibold text-[#0c0479] underline decoration-[#0c0479]/30 underline-offset-2 transition-colors hover:decoration-[#0c0479]"
                        >
              ...
              <div className="overflow-hidden rounded-2xl border border-black/5 bg-white shadow-sm">
                ...
                <div className="p-7 sm:p-8">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-lg font-bold tracking-tight text-black/85">
                      รับใบตรวจสายตาจากฝ่ายพิธีฯ และไปตรวจสายตา
                    </h3>
                  </div>

                  <div className="mt-5 space-y-4 text-[15px] leading-relaxed text-black/55">
                    <p>
                      หลังจากฝ่ายพิธีฯดำเนินการในระบบแล้ว
                      ท่านจะได้รับแบบฟอร์มตรวจสายตาที่มีข้อมูลของท่านอยู่เรียบร้อยแล้ว
                      ให้ท่านนำแบบฟอร์มนี้ไปตรวจสายตา
                    </p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-sm leading-relaxed text-blue-800/70">
                            Arlington Metro at Virginia Square
                          </p>
                          <p className="mt-0.5 text-xs text-blue-700/50">
                    ...
                    <p>
                      หรือท่านสามารถเข้ารับการตรวจสายตาได้ที่ร้านขายแว่นตาเอกชนทั่วไปที่มีจักษุแพทย์ประจำร้าน
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="overflow-hidden rounded-2xl border border-black/5 bg-white shadow-sm">
                ...
                <div className="p-7 sm:p-8">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-lg font-bold tracking-tight text-black/85">
                      นำส่งแบบฟอร์มตรวจสายตากลับมายังฝ่ายพิธีฯ
                    </h3>
                  </div>

                  <div className="mt-5 space-y-4 text-[15px] leading-relaxed text-black/55">
                    <p>
                      เมื่อจักษุแพทย์กรอกแบบฟอร์มเรียบร้อยแล้ว
                      ท่านสามารถนำส่งไฟล์กลับมาทางอีเมลเพื่อให้ฝ่ายพิธีฯ
              ...
              <div className="overflow-hidden rounded-2xl border border-black/5 bg-white shadow-sm">
                ...
                <div className="p-7 sm:p-8">
                  ...
                  <p className="mt-5 text-[15px] leading-relaxed text-black/55">
                    ...
                    ใบขับขี่จะถูกส่งทางไปรษณีย์ตามที่อยู่ที่ท่านได้ให้ไว้
                  </p>
