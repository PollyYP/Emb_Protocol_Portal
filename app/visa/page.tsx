        ...
        <div className="mx-auto max-w-7xl px-6 pt-16 pb-10">
          <FadeIn>
            <div className="mx-auto max-w-4xl">
              ...
              <div className="mt-4 text-sm lg:text-base leading-relaxed text-black/50 indent-[2em]">
                <p>
                  ขณะนี้ สถานเอกอัครราชทูต ณ กรุงวอชิงตัน มีข้อสังเกตว่า การขอต่ออายุวีซ่าประเภท A-2 
                  ได้รับการขยายระยะเวลาจากเดิม 6 เดือน เป็น <span className="font-bold text-[#0c0479]">5 ปี</span> ตามหลักการต่างตอบแทน (Diplomatic Reciprocity) 
