      ...
      <div className="px-4 py-6 sm:px-6 lg:col-span-3 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          ...
          <div className="grid grid-cols-[auto_auto_auto] justify-between gap-x-6">
            {/* หน้าแรก */}
            <div>
              <p className="text-xs lg:text-sm font-medium text-gray-900">เมนูหลัก</p>
            ...
            <div>
              ...
              <ul className="mt-6 space-y-3 text-sm">
                ...
                <li className="text-xs lg:text-sm pt-2 text-[11px] font-semibold uppercase tracking-wider text-black/35">คู่มือการกลับประจำการ</li>
